...
if(isset($_POST['Submit']))
{
   ...
   else
   {
    ...
    $sql=mysqli_query($conn,"SELECT * FROM emp_login where email='$email' and password='$password'");
    $row  = mysqli_fetch_array($sql);
    if(is_array($row))
    {
   
        define('MYSITE',true);
        header("Location: emppage.php?email=".$_POST['email']."");
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right">
              <li><a href="index.php"><i class="lnr lnr-enter"></i> Login</a></li>
        ...
        <div class="row">         
          <div class="col-md-12">
            <div class="breadcrumb-wrapper">
              <h2 class="page-title">Employee Login </h2>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-sm-offset-4 col-md-4 col-md-offset-4">
            <div class="page-login-form box">
              ...
              <form role="form" action="emplogin.php" method="POST" class="login-form">
              ...
              <ul class="form-links">
                <li class="pull-left"><a href="#">Don't have an account?</a></li>
