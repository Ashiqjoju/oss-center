...
if(isset($_POST['Submit']))
{
   ...
   else
   {
    ...
    $sql=mysqli_query($conn,"SELECT * FROM all_products where email='$email' and password='$password'");
    $row  = mysqli_fetch_array($sql);
    if(is_array($row))
    {
   
        define('MYSITE',true);
        header("Location: productpage.php?email=".$_POST['email']."");
        ...
        <div class="row">
          <div class="col-sm-6 col-sm-offset-4 col-md-4 col-md-offset-4">
            <div class="page-login-form box">
              ...
              <form role="form" action="productlogin.php" method="POST" class="login-form">
