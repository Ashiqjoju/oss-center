<?php include_once("config.php");
   ...
   $email = $_GET['email']; 
      ...
      $sql1=mysqli_query($mysqli,"SELECT * FROM admin_login where email='$email'");
...
<html lang="en">
 ...
 $result = mysqli_query($mysqli, "SELECT name FROM admin_login WHERE email = '$email'"); 
          ...
          <div class="row search-bar">
             ...
             <form class="search-form" name="form" >
             				<table border="0" width="100%"><tr><td>
                                        <button style="width:300px;border:none;height:40px;background:dodgerblue;color:white"><a href="add.html">ADD PRODUCTS</a>
                                        </td></tr>
                                        
                                        
                                        <tr><td> <button style="width:300px;border:none;height:40px;margin-top:20px;background:dodgerblue;"><a style="color:white" href="#">VISIT ADS SECTION</a></td></tr></table>
